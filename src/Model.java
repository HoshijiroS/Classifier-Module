/* The Model class produces predictions of a certain instance's 
 * classification based on the features it is given.
 * 
 * Each model has:
 * predictionList: a list of predictions (in String) made by the
 * model on each instance.
 * 
 * accuracy: the accuracy of the model in predicting the class of
 * a certain instance.
 * 
